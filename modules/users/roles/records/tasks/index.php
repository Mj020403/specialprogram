...
page_card_start('Pending Tasks', 'Your records queue with updated table styling and status badges.');
flash_message($flash);
?>

<div class="flex flex-wrap gap-3 mb-6">
    <?php action_button('/harvest/records/dashboard.php', 'Back to Dashboard', 'arrow-left', 'secondary'); ?>
</div>
                ...
                <tbody>
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td><a href="/harvest/records/tasks/view.php?id=<?= (int)$row['id'] ?>">Open</a></td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>
            </table>
