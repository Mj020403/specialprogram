...
page_card_start('Department Review Tasks', 'Department-level review queue for your current assignments.');
flash_message($flash);
?>

<div class="flex flex-wrap gap-3 mb-6">
    <?php action_button('/harvest/department_head/dashboard.php', 'Back to Dashboard', 'arrow-left', 'secondary'); ?>
</div>
                ...
                <tbody>
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td><a href="/harvest/department_head/tasks/view.php?id=<?= (int)$row['id'] ?>">Open</a></td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>
            </table>
